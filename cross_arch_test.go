...
`, "[10, 0.5, 36893488147419103232, 3] 4 error: index out of range [0, 0, 0] 36893488147419103245.5\n"},
	{"strings", `s := "ab"
@ k in 1..=3 {
    s <- s + (k as string)
}
