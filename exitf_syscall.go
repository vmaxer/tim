...
func (fc *TimCompiler) compileExitfSyscall(call *CallExpr, formatStr *StringExpr) {
...
func (fc *TimCompiler) emitStderrLiteral(str string) {
...
func (fc *TimCompiler) emitStderrChar(ch rune) {
...
func (fc *TimCompiler) emitStderrInteger() {
	fc.out.PushReg("rbx")
	fc.out.PushReg("rcx")
	fc.out.PushReg("rdx")
