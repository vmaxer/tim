...
func TestTimHashMapBasicOperations(t *testing.T) {
	m := NewTimHashMap(16)
...
func TestTimHashMapUpdate(t *testing.T) {
	m := NewTimHashMap(16)
...
func TestTimHashMapDelete(t *testing.T) {
	m := NewTimHashMap(16)
...
func TestTimHashMapCollision(t *testing.T) {
	m := NewTimHashMap(4) // Small size to force collisions
...
func TestTimHashMapResize(t *testing.T) {
	m := NewTimHashMap(4)
...
func TestTimHashMapKeys(t *testing.T) {
	m := NewTimHashMap(16)
...
func TestTimHashMapValues(t *testing.T) {
	m := NewTimHashMap(16)
...
func TestTimHashMapEmpty(t *testing.T) {
	m := NewTimHashMap(16)
