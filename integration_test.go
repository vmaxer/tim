...
// TestTimPrograms is an integration test that compiles and runs all .tim testprograms
// and compares their output against .result files

func testTimProgram(t *testing.T, name, srcPath, buildDir string) {
	...
	compileErr := CompileTim(srcPath, executable, platform)
	...
	resultPath := strings.TrimSuffix(srcPath, ".tim") + ".result"
