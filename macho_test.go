...
func TestMachOSegments(t *testing.T) {
	...
	tmpfile, err := os.CreateTemp("", "tim_macho_seg_test")
	if err != nil {
...
func TestMachOPageZero(t *testing.T) {
	...
	tmpfile, err := os.CreateTemp("", "tim_macho_zero_test")
	if err != nil {
		t.Fatalf("Failed to create temp file: %v", err)
	}
	tmpfilePath := tmpfile.Name()
...
func TestMachOTextSegment(t *testing.T) {
	...
	tmpfile, err := os.CreateTemp("", "tim_macho_text_test")
	if err != nil {
		t.Fatalf("Failed to create temp file: %v", err)
	}
	tmpfilePath := tmpfile.Name()
...
func TestMachOMinimalSize(t *testing.T) {
	...
	tmpfile, err := os.CreateTemp("", "tim_macho_size_test")
	if err != nil {
		t.Fatalf("Failed to create temp file: %v", err)
	}
	tmpfilePath := tmpfile.Name()
...
func TestMachOExecutable(t *testing.T) {
	...
	tmpfile, err := os.CreateTemp("", "tim_macho_exec_test")
	if err != nil {
		t.Fatalf("Failed to create temp file: %v", err)
	}
	tmpfilePath := tmpfile.Name()
	...
	// Binary is now self-signed by Tim's generateCodeSignature()
	// No external codesign tool needed!
	t.Logf("Binary self-signed by Tim")
...
func TestMachOFileCommand(t *testing.T) {
	...
	tmpfile, err := os.CreateTemp("", "tim_macho_file_test")
	if err != nil {
		t.Fatalf("Failed to create temp file: %v", err)
	}
	tmpfilePath := tmpfile.Name()
...
func TestMachOPermissions(t *testing.T) {
	...
	tmpfile, err := os.CreateTemp("", "tim_macho_perms_test")
	if err != nil {
		t.Fatalf("Failed to create temp file: %v", err)
	}
	tmpfilePath := tmpfile.Name()
