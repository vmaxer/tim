...
// RepMovsq copies rcx 64-bit quadwords from [rsi] to [rdi], advancing both pointers.
// Clobbers rdi, rsi, rcx. Does not clobber rax, rbx, r8-r15.
// Call Cld() first to ensure forward direction.
func (o *Out) RepMovsq() {
