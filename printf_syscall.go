...
func (fc *TimCompiler) generatePrintfMain() {
	fc.eb.MarkLabel("_tim_printf_syscall")
...
func (fc *TimCompiler) patchShortJump(offsetPos int, targetPos int) {
...
func (fc *TimCompiler) patchCallOffset(offsetPos int, targetPos int) {
	bytes := fc.eb.text.Bytes()
	offset := int32(targetPos - (offsetPos + 4))
	bytes[offsetPos] = byte(offset)
	bytes[offsetPos+1] = byte(offset >> 8)
...
func (fc *TimCompiler) generatePrintString() {
...
func (fc *TimCompiler) generatePrintInteger() {
...
func (fc *TimCompiler) generatePrintUnsigned() {
...
func (fc *TimCompiler) generatePrintFloat() {
