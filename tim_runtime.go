...
func NewTimRuntime(out *Out, eb *ExecutableBuilder) *TimRuntime {
	return &TimRuntime{out: out, eb: eb}
}

// CreateScalar creates a map with single entry {0: value}
// Returns pointer to map in rax
func (fr *TimRuntime) CreateScalar(value float64) {
...
func (fr *TimRuntime) GetScalarValue() {
...
func (fr *TimRuntime) CreateMapFromInt() {
...
func (fr *TimRuntime) BinaryOpScalar(op string) {
...
func (fr *TimRuntime) CreateString() {
...
func (fr *TimRuntime) EmitArenaRuntime() {
